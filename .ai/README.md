...
| Agent                    | File                                    | Role                                                             |
| ------------------------ | --------------------------------------- | ---------------------------------------------------------------- |
| Plectrum _(coordinator)_ | `.github/agents/plectrum.agent.md`      | Orchestrates all subagents for component creation and QA         |
...
shown in the chat dropdown. Only the **Plectrum** coordinator is user-facing.
