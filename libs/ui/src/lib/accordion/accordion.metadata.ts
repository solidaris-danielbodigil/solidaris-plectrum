...
export const AccordionMetadata: ComponentMetadata = {
  component: {
    ...
    figmaUrl:
      'https://www.figma.com/design/wjMnb8GsK8bVKA7UreOJ4L/Plectrum-DS--PrimeNG-v21-?node-id=232-9351',
    created: '2026-09-09',
    modified: '2026-09-09',
  },
  ...
  behavior: {
    ...
    interactions: [
      ...
      'An expanded header gains a bottom border in --pds-color-panel-border; a disabled panel fades to --pds-disabled-opacity with cursor: not-allowed (--pds-cursor-disabled)',
    ],
  },
  props: [],
  accessibility: {
