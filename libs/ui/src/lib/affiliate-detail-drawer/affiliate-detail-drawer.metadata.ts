...
export const AffiliateDetailDrawerMetadata: ComponentMetadata = {
  component: {
    ...
    bemBlock: 'c-affiliate-detail-drawer',
    itcssLayer: '06-components',
    scssPath: 'libs/styles/src/06-components/_components.affiliate-detail-drawer.scss',
    ...
    commonPatterns: [
      {
        ...
        composition:
          '<sds-affiliate-detail-drawer [(visible)]="open" [data]="affiliate" (identifierCopy)="copy($event)" />',
      },
      {
        ...
        composition:
          '<sds-affiliate-detail-drawer [(visible)]="open" [data]="affiliate" [view]="view" (viewChange)="view = $event" />',
      },
    ],
    antiPatterns: [
      {
  ...
  tokens: {
    consumed: [
      '--sds-size-affiliate-detail-drawer-width',
      '--sds-color-affiliate-detail-drawer-bg',
      '--sds-shadow-affiliate-detail-drawer',
      '--sds-shadow-xl',
      '--sds-color-affiliate-detail-drawer-border',
      '--sds-space-affiliate-detail-drawer-header-padding-block-start',
      '--sds-space-affiliate-detail-drawer-header-padding-block-end',
      '--sds-space-affiliate-detail-drawer-padding-inline',
      '--sds-space-affiliate-detail-drawer-content-gap',
      '--sds-space-affiliate-detail-drawer-content-padding-block',
      '--sds-space-affiliate-detail-drawer-section-gap',
      '--sds-size-affiliate-detail-drawer-info-label',
      '--sds-color-affiliate-detail-drawer-metadata-text',
      '--sds-color-affiliate-detail-drawer-metadata-separator',
      '--sds-color-affiliate-detail-drawer-info-label',
      '--sds-color-affiliate-detail-drawer-info-value',
      '--sds-color-affiliate-detail-drawer-relationship',
      '--sds-color-affiliate-detail-drawer-tile-bg',
      '--sds-color-affiliate-detail-drawer-tile-border',
      '--sds-radius-affiliate-detail-drawer-tile',
      '--sds-space-affiliate-detail-drawer-tile-padding-inline-start',
      '--sds-space-affiliate-detail-drawer-tile-padding-inline-end',
      '--sds-space-affiliate-detail-drawer-tile-padding-block',
      '--sds-color-affiliate-detail-drawer-note-bg',
      '--sds-color-affiliate-detail-drawer-note-border',
      '--sds-radius-affiliate-detail-drawer-note',
      '--sds-space-affiliate-detail-drawer-note-padding',
      '--sds-color-affiliate-detail-drawer-note-author',
      '--sds-color-affiliate-detail-drawer-note-timestamp',
      '--sds-color-affiliate-detail-drawer-note-tag-sensitive-bg',
      '--sds-color-affiliate-detail-drawer-note-tag-sensitive-text',
      '--sds-color-avatar-color-blue',
      '--sds-color-avatar-color-green',
      '--sds-color-avatar-color-yellow',
      '--sds-color-avatar-initials-on-yellow',
  ...
  aiHints: {
    priority: 'high',
    context:
      'Affiliate detail drawer for iSHARE audit flows. Headless p-drawer wrapper rendering the full Carte affilié per Figma 7:1012. Reuses sds-plectrum-avatar (large illustrated + small coloured) and the overview-card copyable identifier pattern.',
    selectionCriteria: {
      'detail drawer': 'Slide-in affiliate detail surface with sections and accordions',
      'overview card': 'Use sds-affiliate-overview-card for the inline summary instead',
    },
    keywords: [
      'affiliate',
      'drawer',
