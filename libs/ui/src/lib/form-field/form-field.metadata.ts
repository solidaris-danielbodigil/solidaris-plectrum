...
export const FormFieldMetadata: ComponentMetadata = {
  ...
  <p-iconfield>
    ...
    <p-inputicon>
      ...
      {
        name: 'Vertical field',
        description: 'Default stacked layout.',
  ...
  <p-autocomplete [(ngModel)]="value" required />
      ...
      },
      {
        ...
        description:
          'Set inputId on the control and pass the same value to pds-form-field.',
    ...
    antiPatterns: [
      {
        ...
        reason:
          'FloatLabel animates the placeholder into the label; the design calls for a separate, static, muted label.',
        alternative: 'Use pds-form-field — vertical layout by default.',
      },
      {
        scenario: 'Horizontal layout without a matching inputId',
        reason:
          'Unless inputId matches the control id, the label cannot be associated with the control for assistive technology.',
        alternative:
          'Pass the same value to inputId and to the control id, or point the control at the generated label id with aria-labelledby.',
      },
      {
        scenario: 'Clearable pInputText with type="search"',
        reason:
          'The browser-native clear button conflicts with pds-input-clear.',
        alternative:
          'Use type="text" with role="searchbox" and pds-input-clear inside p-inputicon.',
      },
    ],
  },
  anatomy: [
    {
      part: 'c-form-field',
      role: 'Block — vertical or horizontal via modifiers and o-flex; is-invalid when invalid',
    },
    { part: 'c-form-field__label', role: 'Static label' },
    {
      part: 'c-form-field__required',
      role: 'Decorative asterisk (aria-hidden) followed by a visually hidden (requiredLabel)',
    },
    {
      part: 'c-form-field__control',
      role: 'Projected PrimeNG or native control',
    },
    {
      part: 'c-form-field__hint',
      role: 'Helper text, shown while the field is valid',
    },
    {
      part: 'p-message / [pdsFormFieldError]',
      role: 'Error slot when invalid — errorMessage text or projected content',
    },
  ],
  behavior: {
    ...
    slots: [
      {
        name: 'default',
        description:
          'The control — a PrimeNG or native input, textarea, select or combobox',
      },
      {
        name: '[pdsFormFieldError]',
        description:
          'Custom error content, shown when invalid is true and errorMessage is null',
      },
    ],
  ...
  props: [
    ...
    },
    {
      ...
      default: 'vertical',
      description:
        'Label above the control (vertical) or beside it (horizontal).',
    },
    {
      name: 'required',
      type: 'boolean',
      ...
      default: 'false',
      description:
        'Shows the required marker and sets aria-required on the control.',
    },
    {
      name: 'invalid',
      type: 'boolean',
      ...
      default: 'false',
      description:
        'Invalid state — label colour, aria-invalid, and the error message.',
    },
    {
      name: 'errorMessage',
      type: 'string | null',
      required: false,
      default: 'null',
      description: 'Validation message shown when invalid is true.',
    },
    {
      name: 'inputId',
      ...
      required: false,
      default: 'undefined',
      description: 'Associates the horizontal label with the control id.',
    },
    {
      name: 'hint',
      type: 'string | undefined',
      required: false,
      default: 'undefined',
      description: 'Optional helper text under the control (aria-describedby).',
    },
    {
      name: 'requiredLabel',
      type: 'string',
      required: false,
      default: 'required',
      description: 'Screen-reader text appended after the required asterisk.',
    },
  ],
  aiHints: {
    priority: 'high',
