...
const TELEMETRY_TARGET_LABELS: Record<string, string> = {
  ...
  'category-tab-archives': 'Onglet Archivés',
  'category-tab-isoles': 'Onglet Documents',
  'category-tab-parcours': 'Onglet Parcours',
  'category-toggle-archives': 'Visibilité Archivés',
  'category-toggle-isoles': 'Visibilité Documents',
  'category-toggle-parcours': 'Visibilité Parcours',
