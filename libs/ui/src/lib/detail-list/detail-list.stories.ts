    ...
    ...argTypesFromProps([
      {
        ...
        type: 'string',
        required: false,
        default: 'Numéro national',
        description:
          'First-row dt text in the demo. Production rows are DetailListRow markup.',
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        default: '85.07.30-033.61',
        description: 'First-row dd text in the demo.',
        category: 'Story knobs',
      },
    ]),
    ...classArgTypes([
      {
        name: '.c-detail-list',
        description: 'Block on a semantic dl — rows are flex children.',
      },
      {
        name: '.c-detail-list__label',
        description: 'Fixed-width label column (dt).',
      },
      {
        name: '.c-detail-list__value',
        description: 'Value (dd) — reset margin with o-layout--margin-0.',
      },
      {
        name: 'DetailListRow',
        description:
...
export const Status = {
  tags: ['!dev'],
  ...statusStory(DetailListMetadata.governance, DetailListMetadata.component),
};
export const Usage = {
  tags: ['!dev'],
...
export const Behavior = {
  tags: ['!dev'],
  ...contractStory(DetailListMetadata, 'behavior'),
};
export const Accessibility = {
  tags: ['!dev'],
  ...contractStory(DetailListMetadata, 'accessibility'),
};
...
export const Default: Story = {
  render: (args) => ({
    props: args,
    template: `
      <dl class="c-detail-list o-flex o-flex--y o-layout o-layout--gap-2 o-layout--margin-0" style="max-width: 28rem;">
        <div class="o-flex o-flex--align-items-baseline o-layout o-layout--gap-2">
          <dt class="c-detail-list__label">{{ label }}</dt>
          <dd class="c-detail-list__value o-layout o-layout--margin-0">{{ value }}</dd>
        </div>
...
export const InASection: Story = {
  ...
  render: () => ({
    template: `
      <div class="c-drawer" style="max-width: 28rem;">
        <section class="c-drawer__section o-flex o-flex--y o-layout o-layout--gap-2" aria-labelledby="detail-list-demo-title">
          <h3 id="detail-list-demo-title" class="c-drawer__section-title o-layout o-layout--margin-0">Informations générales</h3>
