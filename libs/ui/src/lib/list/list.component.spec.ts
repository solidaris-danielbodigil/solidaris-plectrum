...
describe('ListComponent', () => {
  ...
  it('should apply flat mode host classes by default', () => {
    ...
    expect(fixture.nativeElement.classList.contains('c-list--journey')).toBe(
      false,
    );
  });
  ...
  it('should apply journey mode host class when groups are provided', () => {
    ...
    expect(fixture.nativeElement.classList.contains('c-list--flat')).toBe(
      false,
    );
  });
  ...
  it('should hide the section header when showHeader is false', () => {
    ...
    expect(
      fixture.nativeElement.querySelector('.c-list__count-badge'),
    ).toBeNull();
  ...
  it('should ignore flat items when rendering journey groups', () => {
    ...
    fixture.componentRef.setInput('groups', JOURNEY_GROUPS);
    fixture.componentRef.setInput('items', standaloneDocuments);
    fixture.componentRef.setInput(
      'expandedGroupIds',
      JOURNEY_GROUPS.map((g) => g.id),
    );
  ...
  it('should emit expandedGroupIdsChange when selectedItemId moves into a collapsed group', () => {
    fixture.componentRef.setInput('groups', JOURNEY_GROUPS);
  ...
  it('should render selected document after auto-expanding its collapsed group', () => {
    fixture.componentRef.setInput('groups', JOURNEY_GROUPS);
    fixture.componentRef.setInput('expandedGroupIds', [
      'parcours-demande-primaire',
    ]);
    ...
    expect(selectedNode?.textContent).toContain('Rechute');
  });
