      ...
      [
        {
          ...
          default: 'left',
          description:
            'PrimeNG p-timeline align — content-only restyle assumes left.',
    ...
    ...classArgTypes([
      {
        ...
        description:
          'Modifier on p-timeline — drops the empty opposite column so content starts at the marker.',
      },
    ]),
  },
  args: { align: 'left' },
...
export const Status = {
  tags: ['!dev'],
  ...statusStory(TimelineMetadata.governance, TimelineMetadata.component),
};
export const Usage = {
  tags: ['!dev'],
...
export const Behavior = {
  tags: ['!dev'],
  ...contractStory(TimelineMetadata, 'behavior'),
};
export const Accessibility = {
  tags: ['!dev'],
  ...contractStory(TimelineMetadata, 'accessibility'),
};
...
export const ContentOnly: Story = {
  ...
  render: (args) => ({
    ...
    template: `
      <p-timeline class="c-timeline c-timeline--content-only" [value]="events" [align]="align" style="max-width: 32rem; display: block;">
