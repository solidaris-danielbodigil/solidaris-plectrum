  ...
  argTypes: {
    'o-flex': {
      ...
      table: {
        ...
        subcategory: 'Block',
        defaultValue: { summary: 'row nowrap' },
      },
    },
    'o-flex--y': {
      name: '.o-flex--y',
      ...
      table: {
        ...
        defaultValue: { summary: 'column nowrap' },
      },
    },
    'flex-flow': {
      name: '.o-flex--xxx',
      ...
      table: {
        category: 'Flex Container',
        subcategory: 'Block-modifier',
        type: { summary: summary(FLEX['flexFlow']) },
        defaultValue: { summary: 'row-nowrap' },
      },
    },
    'align-items': {
      ...
      table: {
        category: 'Flex Container',
        subcategory: 'Block-modifier',
        type: { summary: summary(FLEX['alignItems']) },
    ...
    'align-content': {
      ...
      table: {
        category: 'Flex Container',
        subcategory: 'Block-modifier',
        type: { summary: summary(FLEX['alignContent']) },
        defaultValue: { summary: 'stretch' },
      },
    },
    'justify-content': {
      ...
      table: {
        category: 'Flex Container',
        subcategory: 'Block-modifier',
        type: { summary: summary(FLEX['justifyContent']) },
    ...
    'o-flex__item': {
      ...
      table: {
        category: 'Flex Items',
        subcategory: 'Element',
        defaultValue: { summary: 'flex: 1 1 100%' },
      },
    },
    'o-flex__item--xx': {
    ...
    'align-self': {
      ...
      options: ALIGN_SELF,
      description:
        'Controls the alignment of an individual flex item along the cross axis',
      table: {
        category: 'Flex Items',
        subcategory: 'Element-Modifier',
        type: { summary: summary(FLEX['alignSelf']) },
    ...
    suffixes: {
      ...
      table: {
        ...
        type: { summary: BREAKPOINT_SUFFIXES.join(' | ') },
...
export const Usage = {
  ...
  ...doDontStory({
    dos: [
      {
        title: 'Flex, alignment and 12-col spans in the template',
        detail:
          'o-flex / o-flex__item--{n} / o-flex--y. Gap stays on o-layout--gap-* mixed onto the same element.',
      },
    ],
    donts: [
      {
        title: 'display: flex or a page-scoped grid in 06-components',
        detail:
          'That invents a one-off layout language beside the object classes.',
        alternative:
          'o-flex in the template. Bespoke display: grid stays in SCSS only with a comment (named areas, asymmetric tracks).',
      },
      {
        title: 'Gap or padding on o-flex / o-flex__item in SCSS',
        detail:
          'Those properties are forbidden on the flex objects themselves.',
        alternative: 'o-layout--gap-{scale} as a BEM mix on the same element.',
      },
    ],
  }),
};
