# Styling policy — moved

The Solidaris styling policy lives in the AI knowledge base:

**[`.ai/rules/09-styling-policy.md`](../../.ai/rules/09-styling-policy.md)**

Related rules:

- [`.ai/rules/08-object-classes.md`](../../.ai/rules/08-object-classes.md) — `o-flex` / `o-layout` reference
