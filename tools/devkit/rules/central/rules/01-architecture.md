...
- `candidate` / `app` — owned by an application team registered in `.ai/contracts/registry.json`; titled `Patterns/{App}/…`; other applications propose instead of importing
