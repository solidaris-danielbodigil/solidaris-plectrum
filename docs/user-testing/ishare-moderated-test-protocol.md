...
Note: telemetry exports JSON/CSV at session end via the browser console (`TestingTelemetryService`) — facilitator only.
...
- [ ] Development build with `enableTestingTelemetry: true`.
